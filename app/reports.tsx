...
export default function ReportsScreen() {
  ...
  const exportPayload = useMemo(
    () => ({
      ...
      reportSubtitle: isTr
        ? 'Firma performansi, nakit akisi ve donemsel analiz ozeti'
      ...
      summaryRows: [
        ...
        { label: isTr ? 'Toplam Borc' : 'Total Payables', value: payables },
        { label: isTr ? 'Net Nakit Akisi' : 'Net Cash Flow', value: cashFlow },
        { label: isTr ? 'Ortalama Satis' : 'Average Sale', value: averageSale },
